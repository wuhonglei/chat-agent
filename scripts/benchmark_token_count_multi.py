...
MODELS = [
    # DashScope
    ModelConfig("Qwen3.7 Plus", "dashscope", "https://dashscope.aliyuncs.com/compatible-mode/v1",
                "sk-ws-H.RPRIDHY.CFn8.MEUCIEByfkp6hWTloRNYosesLKyFSulCCfcV3zlJWjyNNI1yAiEAqzXJEOs_gf3jhGe0oegjgRKp7MsdvpDt7AjOl-qLFWE",
                "qwen3.7-plus", 1000000),
    ModelConfig("Qwen3.7 Max", "dashscope", "https://dashscope.aliyuncs.com/compatible-mode/v1",
                "sk-ws-H.RPRIDHY.CFn8.MEUCIEByfkp6hWTloRNYosesLKyFSulCCfcV3zlJWjyNNI1yAiEAqzXJEOs_gf3jhGe0oegjgRKp7MsdvpDt7AjOl-qLFWE",
                "qwen3.7-max", 1000000),
    ModelConfig("GLM 5.2", "dashscope", "https://dashscope.aliyuncs.com/compatible-mode/v1",
                "sk-ws-H.RPRIDHY.CFn8.MEUCIEByfkp6hWTloRNYosesLKyFSulCCfcV3zlJWjyNNI1yAiEAqzXJEOs_gf3jhGe0oegjgRKp7MsdvpDt7AjOl-qLFWE",
                "glm-5.2", 198000),
    ModelConfig("Qwen3.5 Flash", "dashscope", "https://dashscope.aliyuncs.com/compatible-mode/v1",
                "sk-ws-H.RPRIDHY.CFn8.MEUCIEByfkp6hWTloRNYosesLKyFSulCCfcV3zlJWjyNNI1yAiEAqzXJEOs_gf3jhGe0oegjgRKp7MsdvpDt7AjOl-qLFWE",
                "qwen3.5-flash", 1000000),
    # DeepSeek
    ModelConfig("DeepSeek V4 Flash", "deepseek", "https://api.deepseek.com/v1",
                "sk-f8cb83caf1ae4c18929f3d6ca8734414",
                "deepseek-v4-flash", 1000000),
    ModelConfig("DeepSeek V4 Pro", "deepseek", "https://api.deepseek.com/v1",
                "sk-f8cb83caf1ae4c18929f3d6ca8734414",
                "deepseek-v4-pro", 1000000),
    # Kimi
    ModelConfig("Kimi K3", "kimi", "https://api.moonshot.cn/v1",
                "sk-HeW1Te1IcnseuD7BqbpIQLO6rfhwVxMTcyEnFW44oOD6K9mK",
                "kimi-k3", 1000000),
    ModelConfig("Kimi K2.6", "kimi", "https://api.moonshot.cn/v1",
                "sk-HeW1Te1IcnseuD7BqbpIQLO6rfhwVxMTcyEnFW44oOD6K9mK",
                "kimi-k2.6", 256000),
]
...
def main():
    ...
    # 表头
    print(f"{'模型':<25} {'Provider':<12} {'Prompt Tokens':<15} {'与tiktoken差异':<15} {'耗时(ms)':<10}")
    print("-" * 77)

    # tiktoken 基准行
    print(f"{'tiktoken (基准)':<25} {'local':<12} {tiktoken_count:<15} {'-':<15} {'<1':<10}")
    ...
    for item in results:
        ...
        if result["success"]:
            ...
            print(f"{model.name:<25} {model.provider:<12} {result['prompt_tokens']:<15,} {diff_str:<15} {result['latency_ms']:<10.0f}")
        else:
            print(f"{model.name:<25} {model.provider:<12} {'失败':<15} {'-':<15} {'-':<10}")
    ...
    if successful:
        ...
        print(f"极差: {max_tokens - min_tokens:,} ({(max_tokens - min_tokens)/avg_tokens*100:.1f}%)")

        # 找出最接近 tiktoken 的模型
        closest = min(successful, key=lambda x: abs(x["result"]["prompt_tokens"] - tiktoken_count))
        print(f"\n最接近 tiktoken 的模型: {closest['model'].name}")
        print(f"  差异: {abs(closest['result']['prompt_tokens'] - tiktoken_count):,} tokens")
