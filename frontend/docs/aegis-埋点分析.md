 ...
 * 上报自定义事件
 */
export function reportEvent(name: string, params?: Record<string, any>): void {
 ...
 * 上报性能指标
 */
export function reportSpeed(name: string, duration: number, params?: Record<string, any>): void {
  if (typeof aegis !== "undefined" && aegis) {
    aegis.reportSpeed({
      name,
      duration,
 ...
 * 上报错误
 */
export function reportError(error: Error | string, params?: Record<string, any>): void {
  if (typeof aegis !== "undefined" && aegis) {
    const errorInfo =
