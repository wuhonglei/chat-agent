...
export const CHAT_ATTACHMENT_ACCEPT = `image/*,.pdf,application/pdf,.xlsx,${EXCEL_CONTENT_TYPE},.md,.markdown,text/markdown,${TEXT_FILE_ACCEPT}`;
...
export function getChatAttachmentValidationError(file: File, currentCount: number) {
  ...
  if (!isSupportedChatAttachment(file)) {
    return "仅支持 JPEG、PNG、GIF、WebP 图片、PDF、Excel(.xlsx)、Markdown 和文本/代码文件(.csv/.txt/.py/.js/.css/.tsx/.jsx/.less/.sass)";
  }
