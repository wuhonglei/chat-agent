...
async def tavily_extract(
    ...
    timeout: int | None = Field(
        ...
        ge=1,
        le=60,
        description="Maximum time in seconds to wait for the URL extraction before timing out (1-60 seconds). If not specified, default timeouts are applied based on extract_depth: 10 seconds for basic extraction and 30 seconds for advanced extraction",
    ),
) -> TavilyExtractResponse:
    """
