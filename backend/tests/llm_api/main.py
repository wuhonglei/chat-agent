...
response = client.chat.completions.create(
    ...
    messages=[
        ...
        {'role': 'assistant', 'tool_calls': [{'id': 'call_00_i9XOmYzAhm51wf8sKrus8mry', 'function': {
            'arguments': '{"location": "shanghai"}', 'name': 'get_weather_forecast'}, 'type': 'function', 'index': 0}]},
        {'role': 'tool', 'tool_call_id': 'call_00_i9XOmYzAhm51wf8sKrus8mry',
