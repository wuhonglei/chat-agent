...
for comp, x in components.items():
    ...
    ax.text(x, -0.1, comp, ha="center", va="top", fontsize=10, fontweight="bold")
...
ax.arrow(
    components["Cron Job"],
    0.5,
    components["Visibility Service"] - components["Cron Job"],
    0,
    head_width=0.1,
    head_length=0.1,
    fc="blue",
...
ax.text(
    (components["Cron Job"] + components["Visibility Service"]) / 2,
    0.6,
    "触发调度",
    ha="center",
    va="bottom",
...
ax.arrow(
    components["Visibility Service"],
    1.0,
    components["Topic Service"] - components["Visibility Service"],
    0,
    head_width=0.1,
    head_length=0.1,
    fc="green",
...
ax.text(
    (components["Visibility Service"] + components["Topic Service"]) / 2,
    1.1,
    "查询采样Prompt",
    ha="center",
    va="bottom",
...
ax.arrow(
    components["Topic Service"],
    1.5,
    components["Visibility Service"] - components["Topic Service"],
    0,
    head_width=0.1,
    head_length=0.1,
    fc="green",
...
ax.arrow(
    components["Visibility Service"],
    2.0,
    components["Kafka"] - components["Visibility Service"],
    0,
    head_width=0.1,
    head_length=0.1,
    fc="red",
...
ax.text(
    (components["Visibility Service"] + components["Kafka"]) / 2,
    2.1,
    "发布采样任务",
    ha="center",
    va="bottom",
...
ax.arrow(
    components["Kafka"],
    2.5,
    components["Sampling Tool"] - components["Kafka"],
    0,
    head_width=0.1,
    head_length=0.1,
    fc="orange",
...
ax.text(
    (components["Kafka"] + components["Sampling Tool"]) / 2,
    2.6,
    "消费任务",
    ha="center",
    va="bottom",
...
ax.arrow(
    components["Sampling Tool"],
    3.0,
    components["AI Platform"] - components["Sampling Tool"],
    0,
    head_width=0.1,
    head_length=0.1,
    fc="purple",
...
ax.text(
    (components["Sampling Tool"] + components["AI Platform"]) / 2,
    3.1,
    "调用AI平台",
    ha="center",
    va="bottom",
...
ax.arrow(
    ...
    3.5,
    components["Sampling Tool"] - components["AI Platform"],
    0,
    head_width=0.1,
    head_length=0.1,
    fc="purple",
...
ax.arrow(
    components["Sampling Tool"],
    4.0,
    components["S3"] - components["Sampling Tool"],
    0,
    head_width=0.1,
    head_length=0.1,
    fc="brown",
...
ax.text(
    (components["Sampling Tool"] + components["S3"]) / 2,
    4.1,
    "存储截图",
    ha="center",
    va="bottom",
...
ax.arrow(
    components["Sampling Tool"],
    4.5,
    components["MySQL"] - components["Sampling Tool"],
    0,
    head_width=0.1,
    head_length=0.1,
    fc="teal",
...
ax.text(
    (components["Sampling Tool"] + components["MySQL"]) / 2,
    4.6,
    "存储数据",
    ha="center",
    va="bottom",
...
ax.arrow(
    components["MySQL"],
    5.0,
    components["DataStudio"] - components["MySQL"],
    0,
    head_width=0.1,
    head_length=0.1,
    fc="darkblue",
...
ax.text(
    (components["MySQL"] + components["DataStudio"]) / 2,
    5.1,
    "定时同步数据",
    ha="center",
    va="bottom",
