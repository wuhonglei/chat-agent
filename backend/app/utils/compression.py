...
class CompressionResult:
    ...
    key_info_extracted: Optional[List[str]] = None
    ...
    def _compress_web_content(self, content: str) -> str:
        ...
        for line in lines:
            ...
            if any(skip_word in line.lower() for skip_word in
                   ['copyright', 'privacy policy', 'terms of service', 'advertisement', 'cookie']):
                continue
    ...
    def _compress_search_results(self, content: str) -> str:
        ...
        for line in lines:
            ...
            if any(indicator in line.lower() for indicator in
                   ['title:', 'url:', 'snippet:', 'description:', 'summary:']):
    ...
    def _compress_generic_content(self, content: str) -> str:
        ...
        for sentence in sentences:
            ...
            if any(skip_pattern in sentence.lower() for skip_pattern in
                   ['please try again', 'loading', 'error occurred', 'system message']):
                continue
...
class IterationCompressor:
    ...
    def compress_iteration_context(
        ...
        for i, hist_result in enumerate(historical_context):
        ...
        if 'content' in compressed and isinstance(compressed['content'], str):
            ...
            if target_length < original_length:
                ...
                content_type_str = result.get(
                    'content_type', ContentType.GENERIC.value)
                try:
