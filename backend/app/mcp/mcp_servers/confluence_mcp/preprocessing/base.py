...
class BasePreprocessor:
    ...
    def process_html_content(
        ...
        page_id: str = "",
        space_key: str = "",
        confluence_client: Confluence | None = None,
    ) -> tuple[str, str]:
        """
        ...
        Args:
            ...
            page_id: Optional page ID for constructing image URLs
            space_key: Optional space key for constructing image URLs
        ...
        try:
            ...
            # Process images
            self._process_images_in_soup(soup, page_id)
        ...
        for time_tag in time_tags:
            ...
            if datetime_attr:
                try:
                    ...
                    logger.warning(f"Error parsing datetime '{datetime_attr}': {e}")
    ...
    def _process_images_in_soup(self, soup: BeautifulSoup, page_id: str) -> None:
        """
        ...
        Args:
            soup: BeautifulSoup object containing HTML
            page_id: The page ID for constructing download URLs
        """
        ...
        for image_element in image_elements:
            ...
            if attachment_ref:
                ...
                if filename and page_id:
                    ...
                    img_tag["src"] = (
                        f"{self.base_url}/download/attachments/{page_id}/{quote(filename)}"
                    )
            ...
            if page_ref:
                ...
                if page_title:
                    ...
                    if self.base_url:
                        ...
                        a_tag["href"] = (
                            f"{self.base_url}/dosearchsite.action?queryString={page_title}"
                        )
                    else:
    ...
    def _replace_user_mention_by_accountid(
        ...
        try:
            ...
            logger.warning(f"Error processing user mention by account ID: {str(e)}")
            self._use_fallback_user_mention(user_element, account_id)
