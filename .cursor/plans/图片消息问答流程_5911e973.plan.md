...
## 现有流程（与 [`backend/app/api/chat.py`](backend/app/api/chat.py) 相关）
...
- 新增工具函数（建议放在 [`backend/app/schemas/chat.py`](backend/app/schemas/chat.py) 或 `backend/app/utils/` 下专用模块）：输入 `list[ContentBlock]`，输出 OpenAI 风格的 `content`：`str | list[dict]`。
...
| 区域 | 文件 |
|------|------|
| Schema / 转换 | [`backend/app/schemas/chat.py`](backend/app/schemas/chat.py) |
| LLM 消息格式 | [`backend/app/protocols/chat_messages.py`](backend/app/protocols/chat_messages.py) |
| 消息组装 | [`backend/app/agents/base.py`](backend/app/agents/base.py) |
| 会话 Agent | [`backend/app/agents/chat_session_agent.py`](backend/app/agents/chat_session_agent.py) |
| 工具策略 | [`backend/app/agents/tool_call_policy.py`](backend/app/agents/tool_call_policy.py) |
| 工具函数 | [`backend/app/utils/message.py`](backend/app/utils/message.py) |
| 图片路径 | [`backend/app/services/base_service/chat_image_service.py`](backend/app/services/base_service/chat_image_service.py)、[`backend/app/api/file.py`](backend/app/api/file.py) |
| Token | [`backend/app/utils/token.py`](backend/app/utils/token.py) |
